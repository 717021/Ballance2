...
public class Lua_UnityEngine_Animations_ScaleConstraint : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_scaleAtRest(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_scaleAtRest(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_scaleOffset(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.Animations.ScaleConstraint");
		...
		addMember(l,"scaleAtRest",get_scaleAtRest,set_scaleAtRest,true);
		addMember(l,"scaleOffset",get_scaleOffset,set_scaleOffset,true);
		addMember(l,"scalingAxis",get_scalingAxis,set_scalingAxis,true);
		...
		createTypeMetatable(l,null, typeof(UnityEngine.Animations.ScaleConstraint),typeof(UnityEngine.Behaviour));
	}
}
