...
public class Lua_UnityEngine_Graphics : LuaObject {
	...
	static public int DrawMeshInstanced_s(IntPtr l) {
		try {
			...
			#endif
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,1,typeof(UnityEngine.Mesh),typeof(int),typeof(UnityEngine.Material),typeof(List<UnityEngine.Matrix4x4>))){
				UnityEngine.Mesh a1;
				checkType(l,1,out a1);
				System.Int32 a2;
				checkType(l,2,out a2);
			...
			else if(matchType(l,argc,1,typeof(UnityEngine.Mesh),typeof(int),typeof(UnityEngine.Material),typeof(UnityEngine.Matrix4x4[]))){
				UnityEngine.Mesh a1;
				checkType(l,1,out a1);
				System.Int32 a2;
				checkType(l,2,out a2);
