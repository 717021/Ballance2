...
public class Lua_UnityEngine_LightProbes : LuaObject {
	...
	static public int CalculateInterpolatedLightAndOcclusionProbes_s(IntPtr l) {
		try {
			...
			if(matchType(l,argc,1,typeof(List<UnityEngine.Vector3>),typeof(List<UnityEngine.Rendering.SphericalHarmonicsL2>),typeof(List<UnityEngine.Vector4>))){
			...
			else if(matchType(l,argc,1,typeof(UnityEngine.Vector3[]),typeof(UnityEngine.Rendering.SphericalHarmonicsL2[]),typeof(UnityEngine.Vector4[]))){
				UnityEngine.Vector3[] a1;
