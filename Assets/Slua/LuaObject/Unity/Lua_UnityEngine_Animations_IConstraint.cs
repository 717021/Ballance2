...
public class Lua_UnityEngine_Animations_IConstraint : LuaObject {
	...
	static public int AddSource(IntPtr l) {
		try {
			...
			#endif
			UnityEngine.Animations.IConstraint self=(UnityEngine.Animations.IConstraint)checkSelf(l);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.Animations.IConstraint");
		...
		createTypeMetatable(l,null, typeof(UnityEngine.Animations.IConstraint));
	}
}
